...
<section class="row_section" style='  '><div class="container"><div class="row"><div class="col-lg-9 col-md-9 col-sm-12 col-xs-12"><div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><section class="clearfix">       
    	...
    	<section class="breadcrumbs clearfix">
	        <a href="{{URL::to('')}}" title="Trang chủ"><i class="fa fa-home"></i></a>
	            	...
	            	&nbsp;&nbsp;/&nbsp;&nbsp;<a href="#">Tìm kiếm từ khóa "{{{$search}}}"</a>	            	
	            	            					</section>
				  		...
				  		<div class="order-product pull-left">					
                            <div class="btn-group"> 
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="{{URL::to('')}}/tim-kiem.html?key={{$search}}">
                                            <span> Mặc định</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{URL::to('')}}/tim-kiem.html?key={{$search}}&sort=ProductName-asc">
                                            <span><i class="fa fa-sort-alpha-asc"></i> Tên sản phẩm</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{URL::to('')}}/tim-kiem.html?key={{$search}}&sort=ProductName-desc">
                                            <span><i class="fa fa-sort-alpha-desc"></i> Tên sản phẩm</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{URL::to('')}}/tim-kiem.html?key={{$search}}&sort=UnitPrice-asc">
                                            <span><i class="fa fa-sort-numeric-asc"></i> Đơn giá</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{URL::to('')}}/tim-kiem.html?key={{$search}}&sort=UnitPrice-desc">
				...
				<section id="product-listitem">
              	...
              	<div class="listitem box_9 ">
                        <h2>
                        <span>Kết quả của từ khóa "{{{$search}}}"</span>
                        </h2>
                    @if($display == "gird")
                    <div class="row" >
                    @endif
