				  		...
				  		<div class="order-product pull-left">					
                            <div class="btn-group"> 
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="{{URL::to('')}}/dong-ho-{{$type}}.html">
                                            <span> Mặc định</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{URL::to('')}}/dong-ho-{{$type}}.html?sort=ProductName-asc">
                                            <span><i class="fa fa-sort-alpha-asc"></i> Tên sản phẩm</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{URL::to('')}}/dong-ho-{{$type}}.html?sort=ProductName-desc">
                                            <span><i class="fa fa-sort-alpha-desc"></i> Tên sản phẩm</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{URL::to('')}}/dong-ho-{{$type}}.html?sort=UnitPrice-asc">
                                            <span><i class="fa fa-sort-numeric-asc"></i> Đơn giá</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{URL::to('')}}/dong-ho-{{$type}}.html.html?sort=UnitPrice-desc">
