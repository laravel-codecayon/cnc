				...
				<div class="col-md-12">
						<fieldset><legend> Products</legend>
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-6">
										@foreach($tags as $tag)
											<label class="checkbox-inline"> <div class="icheckbox_square-green"><input type="checkbox" name="tags_id[]" @if(in_array($tag->tags_id, $tags_avai)) checked @endif value="{{$tag->tags_id}}" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" ></ins></div> {{{$tag->tags_name}}}</label> 
										@endforeach
