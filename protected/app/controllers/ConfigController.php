...
class ConfigController extends BaseController  {
	...
	public function getTemplateemail(){
		$this->data['arr_file'] = SiteHelpers::getArrayTemplateEmail();
		$this->layout->nest('content','admin/config/templateemail',$this->data)->with('menus', $this->menus );	
	}

	public function postTemplateemail()
	{
		$url =  Input::get('url');
